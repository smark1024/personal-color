...
const Result = memo(() => {
  ...
  // 컬러 변경 핸들러
  const handleColorChange = useCallback(async (colorIndex) => {
            ...
            <div className="result__processing">
              ...
              {(isProcessing || isChangingColor) && (
                <div className="result__processing-overlay">
                  ...
                  <p>{isProcessing ? '컬러 조화 분석 중...' : '컬러 변경 중...'}</p>
                </div>
              )}
            </div>
          </div>
        ...
        {!isProcessing && (
              ...
              <div className="result__alert">
                ...
                <div className="result__alert-content">
                  ...
                  <p className="result__alert-description">
                    정면을 바라보는 얼굴이 명확히 보이는 사진으로<br />다시 시도해주세요.
                  </p>
                  <button 
          ...
          <>
              ...
              <div className="result__palette">
                {result.colors.map((color, idx) => (
                  <ColorChip 
                    ...
                    onClick={() => !isChangingColor && handleColorChange(idx)}
                  />
                ))}
              </div>
            </div>
              ...
              <div className="result__recommendation result__recommendation--best">
                ...
                <ul className="result__recommendation-list">
                  {result.best.map((item, idx) => (
                    <li key={idx} className="result__recommendation-item">
                      • {item}
                    </li>
                  ))}
                </ul>
            ...
            <div className="result__actions">
              <button className="result__retry-button" onClick={() => navigate('/')}>
                <RotateCcw size={20} />
                다시 진단하기
              </button>
            </div>
