...
import { Upload as UploadIcon, X, ChevronLeft, Loader2, Camera, Palette, AlertCircle } from 'lucide-react';
import './Upload.scss';
  ...
  const startCamera = useCallback(async () => {
    ...
    try {
      ...
      if (error.name === 'NotAllowedError') {
        ...
        errorMessage = '카메라에 접근할 수 없습니다. 브라우저를 새로고침하거나 갤러리에서 사진을 선택해주세요.';
      }
    ...
    <div className="upload">
      ...
      {isAnalyzing && (
        <div className="upload__overlay">
          ...
          <p className="upload__overlay-title animate-pulse">당신의 컬러를 찾고 있어요...</p>
      ...
      <div className="upload__content">
        <div className="upload__preview-area">
          {image ? (
            <div className="upload__preview">
              <img src={image} alt="Upload preview" className="upload__preview-image" />
              <button className="upload__delete-button" onClick={() => setImage(null)}>
                <X size={20} />
              </button>
            </div>
          ) : (
            ...
            >
              ...
              <p className="upload__dropzone-subtitle">얼굴이 정면으로 보이는 사진이 가장 정확합니다</p>
        ...
        <div className="upload__actions">
          <p className="upload__tip">💡 자연광에서 찍은 얼굴 정면 사진이 가장 정확합니다.</p>
          <button
            className={`upload__analyze-button ${!image || isAnalyzing ? 'upload__analyze-button--disabled' : ''}`}
        ...
        <div className="upload__camera-modal">
          <div className="upload__camera-container">
            <div className="upload__camera-header">
              ...
              <button 
                className="upload__camera-close"
                onClick={stopCamera}
              >
                <X size={24} />
              </button>
            ...
            <div className="upload__camera-preview">
              {cameraError ? (
                <div className="upload__camera-error">
                  <AlertCircle size={48} />
                  <p className="upload__camera-error-title">카메라를 사용할 수 없습니다</p>
            ...
            {!cameraError && (
              <div className="upload__camera-actions">
                <button 
                  className="upload__capture-button"
